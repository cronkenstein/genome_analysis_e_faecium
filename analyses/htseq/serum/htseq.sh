...
cp -r /proj/uppmax2026-1-61/nobackup/work/acronk/bams/serum/paired/*.bam $SNIC_TMP/paired_aligns
cp -r /proj/uppmax2026-1-61/nobackup/work/acronk/bams/serum/single/*.bam $SNIC_TMP/single_aligns
cp -r /proj/uppmax2026-1-61/nobackup/work/acronk/prokka/PROKKA_05202026/PROKKA_05202026.gff $SNIC_TMP/annotated_assembly
...
mkdir -p /proj/uppmax2026-1-61/nobackup/work/acronk/counts/serum/paired
mkdir -p /proj/uppmax2026-1-61/nobackup/work/acronk/counts/serum/single

cp -r $SNIC_TMP/paired_counts/* /proj/uppmax2026-1-61/nobackup/work/acronk/counts/serum/paired
cp -r $SNIC_TMP/single_counts/* /proj/uppmax2026-1-61/nobackup/work/acronk/counts/serum/single
